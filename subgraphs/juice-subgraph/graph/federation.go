...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Juice":
			resolverName, err := entityResolverNameForJuice(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Juice": %w`, err)
			}
			switch resolverName {
			...
			case "findJuiceByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findJuiceByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindJuiceByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Juice": %w`, err)
				}
...
func entityResolverNameForJuice(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findJuiceByID", nil
	}
	return "", fmt.Errorf("%w for Juice", ErrTypeNotFound)
}
